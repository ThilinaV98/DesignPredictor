      ...
      <table className="widgetLargeTable">
        ...
        <tr className="widgetLargeTr">
          <td className="widgetLargeProduct">
            <img src="https://cdn.shopify.com/s/files/1/2472/1934/products/ladies_maple_printed_t-shirt_2_1024x1024_grande.jpg?v=1513666474" alt="" className="widgetLargeImg" />
            <span className="widgetLargeName">T-Shirt</span>
          </td>
          <td className="widgetLargeQuntity">100</td>
